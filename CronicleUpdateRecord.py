...
def Get_Events():
    url = "http://Cronicle_IP/api/app/get_schedule/v1?api_key=API_KEY"
...
def Delete_Events():
    url = "http://Cronicle_IP/api/app/delete_event/v1?api_key=API_KEY"
...
def Create_Events(h,m,title):
    url = "http://Cronicle_IP/api/app/create_event/v1?api_key=API_KEY"
    body = {'enabled': 1, 
